...
async def send_update(context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        # Run the synchronous Kalshi call in a thread so it doesn't block
...
def main():
    ...
    app.job_queue.run_repeating(send_update, interval=20, first=5)  # slightly slower to reduce load
